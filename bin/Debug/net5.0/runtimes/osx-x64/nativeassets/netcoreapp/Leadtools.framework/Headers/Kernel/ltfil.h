...
#define FILE_RAW_JPEG                     161  // Raw Image Data (JPEG compressed). For information only. LEADTOOLS will neither loar
...
#define ESO2_PDF_LINEARIZED                  0x00080000  // Linearize the PDF file after save
